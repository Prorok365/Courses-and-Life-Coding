"""
 ...
 Description: Count all possibilities of requested number 
              with list of numbers and print all the ways
"""
...
def print_sums(n, parts):
    ...
    for k in parts:
        ...
        variabilities = print_sums(n - k, parts)      #recursive step
...
def main():
    while True:
        ...
        all_variants = print_sums(n, parts)       #Create all possibilities of sum to for n from parts

        for variant in all_variants:
            '''Print all the possible sums of requested num'''
            print(' + '.join(str(num) for num in reversed(variant)))    
